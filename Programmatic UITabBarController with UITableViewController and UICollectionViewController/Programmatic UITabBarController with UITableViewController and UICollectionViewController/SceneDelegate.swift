...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func configureRootViewController() -> UITabBarController {
        ...
        myTableViewController.title = "TableView"
        ...
        myCollectionViewController.title = "CollectionView"
        
        // setup Navigation Controllers
        let tableViewNavigationController = UINavigationController(rootViewController: myTableViewController)
        let collectionViewNavigationController = UINavigationController(rootViewController: myCollectionViewController)
        
        // setup up UITabBarController
        let tabBarController = UITabBarController()
        tabBarController.viewControllers = [tableViewNavigationController, collectionViewNavigationController]
